...
// inputName 이 입력되었을 경우 input 의 경우 e.target.value 필수!
inputName.addEventListener("input", (e) => {
  ...
  /*
        ...
        */
  if (regExp.test(val)) {
    // 소비자가 작성한 값이 [가-힇] 이고, 2글자에서 5글자 사이에 입력한게 맞다면
    nameResult.textContent = "유요한 이름 형식입니다.";
    nameResult.style.color = "green";
  } else {
    nameResult.textContent = "유요하지 않는 이름 형식입니다.";
